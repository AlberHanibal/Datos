 ...
 * @author DAM2A-03
 */
public class ColmenarAlbertoVentanaVuelos extends javax.swing.JFrame {

    private ColmenarAlbertoMVCVuelos MVCVuelos = new ColmenarAlbertoMVCVuelos();

    public ColmenarAlbertoVentanaVuelos() {
        initComponents();
    ...
    private void initComponents() {
        ...
        botonListado.setText("LISTADO DE VUELOS");
    ...
    private void botonListadoActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_botonListadoActionPerformed
        DefaultTableModel tabla = MVCVuelos.generarTablaVuelos();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(ColmenarAlbertoVentanaVuelos.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new ColmenarAlbertoVentanaVuelos().setVisible(true);
            }
        });
    }
