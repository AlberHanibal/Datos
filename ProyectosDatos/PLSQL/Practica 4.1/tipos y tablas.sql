...
CREATE TABLA TABLACLIENTES OF TCLIENTE (IDCLIENTE PRIMARY KEY, NIF UNIQUE);
CREATE TABLE TABLAPRODUCTOS OF TPRODUCTO (IDPRODUCTO PRIMARY KEY);
CREATE TABLA TABLAVENTAS OF TVENTAS(IDVENTA PROMARY KEY) NESTED TABLE LINEAS STORE AS TABLALINEAS;
